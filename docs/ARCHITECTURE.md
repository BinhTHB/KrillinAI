...
- Secrets contain credentials only, e.g. R2 access keys, Telegram token, Gemini API key, and optional Google Drive credentials.
...
- Keep large-file delivery on R2 presigned URLs.
