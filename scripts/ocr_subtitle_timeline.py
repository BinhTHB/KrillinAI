...
def main() -> int:
    ...
    parser.add_argument("--crop-top", type=float, default=0.75)
    parser.add_argument("--crop-bottom", type=float, default=0.95)
    parser.add_argument("--crop-left", type=float, default=0.25)
    parser.add_argument("--crop-right", type=float, default=0.75)
    parser.add_argument("--min-conf", type=float, default=0.25)
    parser.add_argument("--max-gap", type=float, default=0.45)
