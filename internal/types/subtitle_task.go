...
10. **Wuxia/Martial Arts Style (Võ Hiệp)**: Use traditional wuxia style pronouns and addressing terms in Vietnamese (e.g., "huynh", "đệ", "muội", "tại hạ", "các vị", "các hạ", "tiền bối", "vãn bối", "tiểu tử", "lão phu"). STRICTLY AVOID modern, intimate, or colloquial pronouns like "bạn", "tớ", "cậu", "mày", "tao" unless historically appropriate for the character relationship.
